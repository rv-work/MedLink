  ...
  return (
    <footer className="relative bg-gradient-to-br from-blue-900 via-purple-900 to-teal-900 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-1/2 left-1/3 w-24 h-24 bg-teal-400/10 rounded-full blur-2xl animate-bounce"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/80 text-base leading-relaxed mb-6">
              We are dedicated to providing a secure, modern platform to store,
              manage, and access your health data with complete privacy and 24/7
              accessibility.
            </p>
              ...
              <div className="flex items-center space-x-3 text-white/80">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    Healthcare District, Medical City
                  </p>
                </div>
              </div>
            </div>
